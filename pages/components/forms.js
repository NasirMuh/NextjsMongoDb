...
const Forms = ({ test }) => {
    ...
    const deleteData = async (_id) => {
        const res = await fetch(`/api/userInfo/${_id}`, {
            method: "DELETE"
        })
        const data = await res.json()
        router.push('/components/forms')
    ...
    const detailData = async (_id) => {
        const res = await fetch(`/api/userInfo/${_id}`, {
            method: "GET"
        })
        const data = await res.json()
        router.push({
            pathname: '/components/detailPage',
            query:  {_id} 
          });
    ...
    return (
        <>
            <button onClick={() => openForm()} type="button" className="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Create</button>
            ...
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                <div className="flex items-center justify-between pb-4">
                    <div>
                        ...
                        <div id="dropdownRadio" className="z-10 hidden w-48 bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="top" style={{ position: "absolute", inset: "auto auto 0px 0px", margin: "0px", transform: "translate3d(522.5px, 3847.5px, 0px)" }}>
                    ...
                    <tbody>
                        {test.data?.map((data) => {
                            ...
                            return (<tr key={_id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td className="px-6 py-4">
                                    <button onClick={() => deleteData(_id)} className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Delete</button> | <span> </span>
                                    <button onClick={() => detailData(_id)} className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Detail</button>
...
//   const { data } = await axios.get('http://localhost:3000/api/userInfo')
//   return {
//     props: {
//       users: data
//     }
